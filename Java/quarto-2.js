function alterarPreco_1() {
    ...
    var novoPreco = Math.floor(Math.random() + 275);
  ...
  function alterarPreco_3() 
  {
    ...
    var novoPreco = Math.floor(Math.random() + 325);
  ...
  function alterarPreco_5() 
  {
    ...
    var novoPreco = Math.floor(Math.random() + 375);
  ...
  function alterarPreco_7() 
  {
    ...
    var novoPreco = Math.floor(Math.random() + 425);
